...
import { CheckCircle, XCircle, FileText, TrendingUp, TrendingDown, ArrowRight } from "lucide-react";
...
export default function PLApproval() {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-2xl font-bold text-slate-900">Practice Lead Approval</h1>
        <p className="text-sm text-slate-500 mt-1">Review and approve forecast submissions before Practice Head review</p>
      </div>
      ...
      {isLoading ? (
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-slate-100 flex items-center justify-center" style={{ minHeight: "400px" }}>
          <div className="text-center px-8 py-16">
            ...
            <h2 className="text-xl font-semibold text-slate-800 mb-2">No pending approvals</h2>
            <p className="text-slate-400 text-sm mb-6 max-w-xs mx-auto">
              All batches have been reviewed.<br />Check back later for new submissions.
            </p>
            <button
                ...
                <div className="border-t border-slate-100 p-5 space-y-4 bg-slate-50">
                  <div>
                    ...
                    <textarea
                      ...
                      placeholder="Add comments for rejection feedback or approval notes..."
                      rows={3}
