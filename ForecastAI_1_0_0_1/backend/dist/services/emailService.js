...
exports.sendPLApprovalEmail = sendPLApprovalEmail;
exports.sendPHApprovalEmail = sendPHApprovalEmail;
exports.sendCommentEmailToPM = sendCommentEmailToPM;
...
async function sendPLApprovalEmail(batch) {
    const msg = {
        to: PL_EMAIL,
        from: FROM_EMAIL,
...
async function sendPHApprovalEmail(batch) {
    const msg = {
        to: PH_EMAIL,
        from: FROM_EMAIL,
...
async function sendCommentEmailToPM(project, comment, commenterName) {
